...
export const Markdown = defineComponent({
  ...
  props: {
    ...
    markdownCustomStyles: {
      type: Object as PropType<MarkdownStylesType>,
      default: undefined,
    },
  ...
  setup(props, { slots, attrs }) {
    return () => {
      let markdownSource = props.source ?? '';

      if (!markdownSource && slots.default) {
      ...
      return h('div', {
        ...attrs,
        innerHTML: marked.parse(markdownSource, {
          renderer,
          async: false,
        }),
